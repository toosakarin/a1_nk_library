...
import com.fuhu.konnect.paint.view.EffectButton;
import com.fuhu.konnect.paint.view.StickerContentButton;
import com.fuhu.konnect.paint.view.WallpaperContentButton;
import com.fuhu.konnect.paint.effect.CameraEffect;
import com.fuhu.konnect.paint.effect.EffectManager;
import com.fuhu.konnect.paint.effect.EraserEffect;
import com.fuhu.konnect.paint.effect.PaintEffect;
import com.fuhu.konnect.paint.effect.StickerEffect;
import com.fuhu.konnect.paint.effect.WallPaperEffect;
import com.fuhu.konnect.paint.effect.WallPaperEffectDefault;
 ...
 */
public class PaintDemoFragment extends Fragment {
    ...
    /**
     * Those two views are linked from jackjack library
     */
...
//                            .show();
    ...
    private class MySubEffectAdapter extends PaintView.SubEffectAdapter<MySubEffectVH> {
        ...
        public MySubEffectVH onCreateViewHolder(ViewGroup parent, int viewType) {
            EffectButton view = new EffectButton(PaintDemoFragment.this.getActivity());
