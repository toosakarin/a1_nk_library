 ...
 */
public class AvatarSolidFragment extends Fragment {

    public static final String TAG = AvatarSolidFragment.class.getSimpleName();
...
//        mSubjectView.addSubject(subject, subjectIndex, contentKey);
...
//        @Override
//        public Object onBindViewHolder(MyHolder holder, View currentSubject, int position) {
//            Object key = null;
//
//            //jack@150618
...
//        @Override
//        public Bitmap getSelectedContentBitmap(Object key) {
//            Log.e(TAG, "getSelectedContentBitmap()->key=" + key);
//
//            Bitmap bmp = null;
//
//            if(key != null) {
//                int resourceId = (int) key;
...
//        @Override
//        public void onContentConfused(Object[] keys, Bitmap confusedImage) {
