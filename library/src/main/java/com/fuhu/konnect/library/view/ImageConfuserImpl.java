 ...
 */
public class ImageConfuserImpl implements ImageConfuser {

    public static final String TAG = ImageConfuserImpl.class.getSimpleName();
    ...
    public ImageConfuserImpl(int w, int h) {
        mBaseWidth = w;
        mBaseHeight = h;
    }
